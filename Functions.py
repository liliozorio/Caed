...
def criaDataBase():
  ...
  for i in range(0,20):
    frase1 = open("/Dataset/DatasetCaed/1_Ensino_Fundamental_I" + str(lista1[i]) + ".txt")
    frase1 = frase1.read()
    frases = frase1.split('.')
    for frase in frases:
      frase = frase.replace('\n', '')
    ...
    frase2 = open("/Dataset/DatasetCaed/2_Ensino_Fundamental_II/" + str(lista2[i]) + ".txt")
    frase2 = frase2.read()
    frases = frase2.split('.')
    for frase in frases:
      frase = frase.replace('\n', '')
    ...
    frase3 = open("/Dataset/DatasetCaed/3_Ensino_Medio/" + str(lista3[i]) + ".txt")
    frase3 = frase3.read()
    frases = frase3.split('.')
    for frase in frases:
      frase = frase.replace('\n', '')
    ...
    frase4 = open("/Dataset/DatasetCaed/4_Ensino_Superior/" + str(lista4[i]) + ".txt")
    frase4 = frase4.read()
    frases = frase4.split('.')
    for frase in frases:
      frase = frase.replace('\n', '')
